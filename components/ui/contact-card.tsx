...
export function ContactCard() {
	return (
		<Card className="font-(family-name:--font-poppins-sans)">
			...
			<CardDescription>
				Feel free to reach out to me with your design queries or if you
				just want to say Hi 👋
			</CardDescription>
		</Card>
	);
...
const Skeleton = () => {
	return (
		<>
			<div className="p-4 overflow-hidden h-full relative flex flex-col items-left justify-self-auto">
				<a
				...
				>
					...
					>
						<path
							d="M0,4 C0,2.895431 0.895431,2 2,2 L14,2 C15.1046,2 16,2.895431 16,4 L16,12 C16,13.1046 15.1046,14 14,14 L2,14 C0.895431,14 0,13.1046 0,12 L0,4 Z M2,4 L14,4 L14,4.0077 L8.00395,7.46952 L2,4.00315 L2,4 Z M2,6.31255 L2,12 L14,12 L14,6.3171 L8.00395,9.77893 L2,6.31255 Z"
							fill="currentColor"
						/>
					</svg>
